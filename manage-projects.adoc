...
[role="lead"]
Sie können Builder-Projekte verwalten, um zu steuern, wie Ihr Code und Ihre Artefakte für jedes Projekt in NetApp Workload Factory für Builder verwaltet werden.
...
+
... *Maximale Aufbewahrung in Tagen*: Geben Sie die maximale Anzahl von Tagen ein, die ein Klon aufbewahrt werden soll.  Nach dieser Anzahl von Tagen entfernt Workload Factory den Klon.
...
Sie können vorhandene, in NetApp Workload Factory for Builders erstellte Projekte anzeigen, indem Sie diese Schritte ausführen.
